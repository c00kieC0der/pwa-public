...
helper.loadTemplateWithClass = function(elementId, type, name){
    var path = '/ss-SS/templates/' + type + '/' + name + '/' + name + '.html';
...
helper.ngRepeat = function(divId, componentName, dataMap, data, multiplier){
    ...
    var path = '/ss-SS/templates/components/' + componentName + '/' + componentName + '.html';
    var xhr = typeof XMLHttpRequest !== 'undefined' ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
...
helper.setCanonical = function(){
    ...
    var getPage = function(){
          var hrefJSONfile = '/ss-SS/js-src/hreflangs/hreflang_' + _Router.page + '_page.json';
