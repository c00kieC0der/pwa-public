...
s.linkInternalFilters="javascript:,weather.com"; //optional: add your internal domain here
...
s.trackingServerSecure="sodc.weather.com";
...
function sc_trackAction(obj,actionId){
  try{
    s.prop35=actionId;
