...
var language =  savedPco.user && savedPco.user.locale ? savedPco.user.locale.replace('_', '-'): "en-US";
...
(function($$){
    ...
    // Wait for Data call to resolve
        document.getElementById('event-anchor').addEventListener('worker-builder', function(e) {
        console.log('cust_params fired...', new Date().getTime() - window.renderStartTime, e);
...
!function($$) {
    ...
    loadJSON(function(response){
        ...
        adUnit = isMobile ? localeToAdUnitMap[language].m_mweb_wx : localeToAdUnitMap[language].wx_online;
